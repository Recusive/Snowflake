    ...
    match mode {
        ...
        RunDebugMode::Debug => container(stack((
            ...
            },
            {
                let terminal = terminal.clone();
                clickable_icon(
                    || SnowflakeIcons::DEBUG_STEP_OVER,
                    move || {
            ...
            },
            {
                let terminal = terminal.clone();
                clickable_icon(
                    || SnowflakeIcons::DEBUG_STEP_INTO,
                    move || {
                ...
                stack((
                    {
                        let svg_str = match (&p.mode, p.stopped) {
                            (RunDebugMode::Run, false) => SnowflakeIcons::START,
                            (RunDebugMode::Run, true) => SnowflakeIcons::RUN_ERRORS,
                            (RunDebugMode::Debug, false) => SnowflakeIcons::DEBUG,
                            (RunDebugMode::Debug, true) => {
                                SnowflakeIcons::DEBUG_DISCONNECT
                            }
                        };
                        ...
                        s.items_center()
                            ...
                            .hover(|s| {
                                s.apply_if(reference > 0, |s| {
                                    s.background(
                                        config.get().color(
                                            SnowflakeColor::PANEL_HOVERED_BACKGROUND,
                                        ),
                                    )
                                })
                            })
                ...
                .style(move |s| {
                    ...
                    s.padding_left(20.0)
                        ...
                        .apply_if(!has_source, |s| {
                            s.color(config.color(SnowflakeColor::EDITOR_DIM))
                        })
                        .hover(|s| {
                            s.background(
                                config.color(SnowflakeColor::PANEL_HOVERED_BACKGROUND),
