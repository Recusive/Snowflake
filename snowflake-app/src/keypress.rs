...
use snowflake_core::mode::{Mode, Modes};
...
use crate::{
    command::{CommandExecuted, CommandKind, SnowflakeCommand, snowflake_internal_commands},
...
pub struct KeyPressData {
    ...
    pub commands: Rc<IndexMap<String, SnowflakeCommand>>,
    ...
    pub commands_without_keymap: Rc<Vec<SnowflakeCommand>>,
}

impl KeyPressData {
    pub fn new(cx: Scope, config: &SnowflakeConfig) -> Self {
        ...
        let mut keypress = Self {
            ...
            commands: Rc::new(snowflake_internal_commands()),
    ...
    pub fn update_keymaps(&mut self, config: &SnowflakeConfig) {
