...
use snowflake_core::mode::{Mode, VisualMode};
use lsp_types::{DiagnosticSeverity, ProgressToken};

use crate::{
    app::clickable_icon,
    command::SnowflakeWorkbenchCommand,
...
pub fn status(
    ...
    _config: ReadSignal<Arc<SnowflakeConfig>>,
) -> impl View {
        ...
        stack((
            ...
            .style(move |s| {
                ...
                let (bg, fg) = match mode.get() {
                    Mode::Normal => (
                        SnowflakeColor::STATUS_MODAL_NORMAL_BACKGROUND,
                        SnowflakeColor::STATUS_MODAL_NORMAL_FOREGROUND,
                    ),
                    Mode::Insert => (
                        SnowflakeColor::STATUS_MODAL_INSERT_BACKGROUND,
                        SnowflakeColor::STATUS_MODAL_INSERT_FOREGROUND,
                    ),
                    Mode::Visual(_) => (
                        SnowflakeColor::STATUS_MODAL_VISUAL_BACKGROUND,
                        SnowflakeColor::STATUS_MODAL_VISUAL_FOREGROUND,
                    ),
                    Mode::Terminal => (
                        SnowflakeColor::STATUS_MODAL_TERMINAL_BACKGROUND,
                        SnowflakeColor::STATUS_MODAL_TERMINAL_FOREGROUND,
                    ),
                };
            ...
            stack((
                svg(move || config.get().ui_svg(SnowflakeIcons::SCM)).style(move |s| {
                    let config = config.get();
                ...
                label(branch).style(move |s| {
                    s.margin_left(10.0)
                        .color(config.get().color(SnowflakeColor::STATUS_FOREGROUND))
                        .selectable(false)
                }),
            ))
            .style(move |s| {
                ...
                .hover(|s| {
                    s.cursor(CursorStyle::Pointer).background(
                        config.get().color(SnowflakeColor::PANEL_HOVERED_BACKGROUND),
                    )
                })
            })
            ...
            .on_event(
                ...
                move |_| {
                    if pointer_down.get() {
                        workbench_command
                            .send(SnowflakeWorkbenchCommand::PaletteSCMReferences);
                    }
            ...
            ),
            {
                ...
                stack((
                    svg(move || config.get().ui_svg(SnowflakeIcons::ERROR)).style(
                        move |s| {
                            let config = config.get();
                        ...
                        move |s| {
                            s.margin_left(5.0)
                                .color(
                                    config
                                        .get()
                                        .color(SnowflakeColor::STATUS_FOREGROUND),
                                )
                                .selectable(false)
                        },
                    ),
                    svg(move || config.get().ui_svg(SnowflakeIcons::WARNING)).style(
                        move |s| {
                            let config = config.get();
                            let size = config.ui.icon_size() as f32;
                            s.size(size, size)
        ...
        stack((
            {
                ...
                let icon = {
                    ...
                    move || {
                        ...
                        {
                            SnowflakeIcons::SIDEBAR_LEFT
                        } else {
                            SnowflakeIcons::SIDEBAR_LEFT_OFF
                        }
                    }
                };
                clickable_icon(
                ...
                let icon = {
                    ...
                    move || {
                        if panel.is_container_shown(
                            ...
                            SnowflakeIcons::LAYOUT_PANEL
                        } else {
                            SnowflakeIcons::LAYOUT_PANEL_OFF
                        }
                    }
                };
                clickable_icon(
            ...
            },
            {
                ...
                let icon = {
                    ...
                    move || {
                        ...
                        {
                            SnowflakeIcons::SIDEBAR_RIGHT
                        } else {
                            SnowflakeIcons::SIDEBAR_RIGHT_OFF
                        }
                    }
                };
                clickable_icon(
    ...
    .style(move |s| {
        ...
        s.border_top(1.0)
            ...
            .background(config.color(SnowflakeColor::STATUS_BACKGROUND))
...
fn status_text<S: std::fmt::Display + 'static>(
    ...
    label(text).style(move |s| {
        ...
        s.display(display)
            ...
            .padding_horiz(10.0)
            .items_center()
            .color(config.color(SnowflakeColor::STATUS_FOREGROUND))
            .hover(|s| {
