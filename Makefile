# This Makefile is intended *only* for building macOS binaries of Snowflake.
...
app: $(APP_NAME)-native ## Create a Snowflake.app
app-universal: $(APP_NAME)-universal ## Create a universal Snowflake.app
$(APP_NAME)-%: $(TARGET)-%
	...
	xattr -c $(APP_DIR)/$(APP_NAME)/Contents/Resources/snowflake.icns
...
dmg: $(DMG_NAME)-native ## Create a Snowflake.dmg
dmg-universal: $(DMG_NAME)-universal ## Create a universal Snowflake.dmg
$(DMG_NAME)-%: $(APP_NAME)-%
