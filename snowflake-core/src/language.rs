...
use snowflake_rpc::style::{LineStyle, Style};
...
/// indices into the LANGUAGES array.  See method `SnowflakeLanguage::properties`.
///
...
/// `SnowflakeLanguage` as they will be accessed using the enum variants as indices.
const LANGUAGES: &[SyntaxProperties] = &[
    // Undetected/unmatched fallback or just plain file
    SyntaxProperties {
        id: SnowflakeLanguage::PlainText,
        indent: Indent::tab(),
        files: &[],
        extensions: &["txt"],
    ...
    SyntaxProperties {
        id: SnowflakeLanguage::Beancount,
        indent: Indent::tab(),
        files: &[],
        extensions: &[],
        comment: comment_properties!(),
    ...
    SyntaxProperties {
        id: SnowflakeLanguage::Dockerfile,
        indent: Indent::space(2),
    ...
    SyntaxProperties {
        id: SnowflakeLanguage::Gitattributes,
        indent: Indent::tab(),
        files: &[],
        extensions: &[],
        comment: comment_properties!(),
    ...
    SyntaxProperties {
        id: SnowflakeLanguage::GitCommit,
        indent: Indent::tab(),
        files: &[],
        extensions: &[],
        comment: comment_properties!(),
    ...
    SyntaxProperties {
        id: SnowflakeLanguage::GitConfig,
        indent: Indent::tab(),
    ...
    SyntaxProperties {
        id: SnowflakeLanguage::GitRebase,
        indent: Indent::tab(),
        files: &[],
        extensions: &[],
        comment: comment_properties!(),
    ...
    SyntaxProperties {
        id: SnowflakeLanguage::GoTemplate,
        indent: Indent::tab(),
        files: &[],
        extensions: &[],
        comment: comment_properties!(),
    ...
    SyntaxProperties {
        id: SnowflakeLanguage::Javascript,
        indent: Indent::space(2),
        files: &[],
    ...
    SyntaxProperties {
        id: SnowflakeLanguage::KotlinBuildScript,
        indent: Indent::space(2),
        files: &[],
        extensions: &["kts"],
        comment: CommentProperties {
    ...
    SyntaxProperties {
        id: SnowflakeLanguage::MarkdownInline,
        indent: Indent::space(4),
    ...
    SyntaxProperties {
        id: SnowflakeLanguage::OcamlInterface,
        indent: Indent::space(2),
        files: &[],
        extensions: &["mli"],
        comment: comment_properties!("(*"),
    ...
    SyntaxProperties {
        id: SnowflakeLanguage::PowerShell,
        indent: Indent::space(4),
        files: &[],
    ...
    SyntaxProperties {
        id: SnowflakeLanguage::ShellScript,
        indent: Indent::space(2),
        files: &[],
        extensions: &["sh"],
        comment: comment_properties!("#"),
    ...
    SyntaxProperties {
        id: SnowflakeLanguage::SshClientConfig,
        indent: Indent::tab(),
        files: &[],
        extensions: &[],
        comment: comment_properties!(),
    ...
    SyntaxProperties {
        id: SnowflakeLanguage::Typescript,
        indent: Indent::space(4),
        files: &[],
...
impl SnowflakeLanguage {
    ...
    pub fn from_path(path: &Path) -> SnowflakeLanguage {
        Self::from_path_raw(path).unwrap_or(SnowflakeLanguage::PlainText)
    }

    pub fn from_path_raw(path: &Path) -> Option<SnowflakeLanguage> {
    ...
    pub fn from_name(name: &str) -> Option<SnowflakeLanguage> {
        match SnowflakeLanguage::from_str(name.to_lowercase().as_str()) {
            Ok(v) => Some(v),
            Err(e) => {
                event!(Level::DEBUG, "failed parsing `{name}` SnowflakeLanguage: {e}");
                None
            }
        }
    }
    ...
    fn get_grammar(&self) -> Option<tree_sitter::Language> {
        ...
        if let Some(grammars_dir) = Directory::grammars_directory() {
            match self::load_grammar(&grammar_name, &grammar_fn_name, &grammars_dir)
            {
                ...
                Err(err) => {
                    if self != &SnowflakeLanguage::PlainText {
...
mod tests {
    ...
    use super::SnowflakeLanguage;

    #[test]
    fn test_lanaguage_from_path() {
        let l = SnowflakeLanguage::from_path(&PathBuf::new().join("test.rs"));
        assert_eq!(l, SnowflakeLanguage::Rust);
    }
}
