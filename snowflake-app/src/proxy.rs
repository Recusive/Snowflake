...
use snowflake_proxy::dispatch::Dispatcher;
use snowflake_rpc::{
...
impl CoreHandler for Proxy {
    fn handle_notification(&mut self, rpc: snowflake_rpc::core::CoreNotification) {
    ...
    fn handle_request(
        &mut self,
        _id: snowflake_rpc::RequestId,
        _rpc: snowflake_rpc::core::CoreRequest,
    ) {
    }
}
