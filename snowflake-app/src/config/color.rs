...
pub struct SnowflakeColor {}

impl SnowflakeColor {
    pub const LAPCE_WARN: &'static str = "snowflake.warn";
    pub const LAPCE_ERROR: &'static str = "snowflake.error";
    pub const LAPCE_DROPDOWN_SHADOW: &'static str = "snowflake.dropdown_shadow";
    pub const LAPCE_BORDER: &'static str = "snowflake.border";
    pub const LAPCE_SCROLL_BAR: &'static str = "snowflake.scroll_bar";

    pub const LAPCE_BUTTON_PRIMARY_BACKGROUND: &'static str =
        "snowflake.button.primary.background";
    pub const LAPCE_BUTTON_PRIMARY_FOREGROUND: &'static str =
        "snowflake.button.primary.foreground";

    pub const LAPCE_TAB_ACTIVE_BACKGROUND: &'static str =
        "snowflake.tab.active.background";
    pub const LAPCE_TAB_ACTIVE_FOREGROUND: &'static str =
        "snowflake.tab.active.foreground";
    pub const LAPCE_TAB_ACTIVE_UNDERLINE: &'static str =
        "snowflake.tab.active.underline";

    pub const LAPCE_TAB_INACTIVE_BACKGROUND: &'static str =
        "snowflake.tab.inactive.background";
    pub const LAPCE_TAB_INACTIVE_FOREGROUND: &'static str =
        "snowflake.tab.inactive.foreground";
    pub const LAPCE_TAB_INACTIVE_UNDERLINE: &'static str =
        "snowflake.tab.inactive.underline";

    pub const LAPCE_TAB_SEPARATOR: &'static str = "snowflake.tab.separator";

    pub const LAPCE_ICON_ACTIVE: &'static str = "snowflake.icon.active";
    pub const LAPCE_ICON_INACTIVE: &'static str = "snowflake.icon.inactive";

    pub const LAPCE_REMOTE_ICON: &'static str = "snowflake.remote.icon";
    pub const LAPCE_REMOTE_LOCAL: &'static str = "snowflake.remote.local";
    pub const LAPCE_REMOTE_CONNECTED: &'static str = "snowflake.remote.connected";
    pub const LAPCE_REMOTE_CONNECTING: &'static str = "snowflake.remote.connecting";
    pub const LAPCE_REMOTE_DISCONNECTED: &'static str = "snowflake.remote.disconnected";

    pub const LAPCE_PLUGIN_NAME: &'static str = "snowflake.plugin.name";
    pub const LAPCE_PLUGIN_DESCRIPTION: &'static str = "snowflake.plugin.description";
    pub const LAPCE_PLUGIN_AUTHOR: &'static str = "snowflake.plugin.author";
