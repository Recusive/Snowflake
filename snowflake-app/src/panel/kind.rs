...
use crate::config::icon::SnowflakeIcons;
...
impl PanelKind {
    pub fn svg_name(&self) -> &'static str {
        match &self {
            PanelKind::Terminal => SnowflakeIcons::TERMINAL,
            PanelKind::FileExplorer => SnowflakeIcons::FILE_EXPLORER,
            PanelKind::SourceControl => SnowflakeIcons::SCM,
            PanelKind::Plugin => SnowflakeIcons::EXTENSIONS,
            PanelKind::Search => SnowflakeIcons::SEARCH,
            PanelKind::Problem => SnowflakeIcons::PROBLEM,
            PanelKind::Debug => SnowflakeIcons::DEBUG,
            PanelKind::CallHierarchy => SnowflakeIcons::TYPE_HIERARCHY,
            PanelKind::DocumentSymbol => SnowflakeIcons::DOCUMENT_SYMBOL,
            PanelKind::References => SnowflakeIcons::REFERENCES,
            PanelKind::Implementation => SnowflakeIcons::IMPLEMENTATION,
        }
    }
