...
use crate::{language::SnowflakeLanguage, style::SCOPES};

thread_local! {
    static HIGHLIGHT_CONFIGS: RefCell<HashMap<SnowflakeLanguage, Result<Arc<HighlightConfiguration>, HighlightIssue>>> = Default::default();
}
