    ...
    pub fn view_info(
        ...
        match self.clone() {
            EditorTabChild::Editor(editor_id) => create_memo(move |_| {
                ...
                let (icon, color, name, confirmed, is_pristine) = match path {
                    ...
                    None => (
                        ...
                        Some(config.color(SnowflakeColor::LAPCE_ICON_ACTIVE)),
                        "local".to_string(),
            ...
            EditorTabChild::Settings(_) => create_memo(move |_| {
                let config = config.get();
                EditorTabChildViewInfo {
                    icon: config.ui_svg(SnowflakeIcons::SETTINGS),
                    color: Some(config.color(SnowflakeColor::LAPCE_ICON_ACTIVE)),
            ...
            EditorTabChild::ThemeColorSettings(_) => create_memo(move |_| {
                let config = config.get();
                EditorTabChildViewInfo {
                    icon: config.ui_svg(SnowflakeIcons::SYMBOL_COLOR),
                    color: Some(config.color(SnowflakeColor::LAPCE_ICON_ACTIVE)),
            ...
            EditorTabChild::Keymap(_) => create_memo(move |_| {
                let config = config.get();
                EditorTabChildViewInfo {
                    icon: config.ui_svg(SnowflakeIcons::KEYBOARD),
                    color: Some(config.color(SnowflakeColor::LAPCE_ICON_ACTIVE)),
            ...
            EditorTabChild::Volt(_, id) => create_memo(move |_| {
                ...
                EditorTabChildViewInfo {
                    icon: config.ui_svg(SnowflakeIcons::EXTENSIONS),
                    color: Some(config.color(SnowflakeColor::LAPCE_ICON_ACTIVE)),
                    name: display_name,
                    path: None,
                    confirmed: None,
