    ...
    let install_button =
        move |id: VoltID, info: RwSignal<VoltInfo>, installing: RwSignal<bool>| {
            ...
            .style(move |s| {
                ...
                s.color(config.color(SnowflakeColor::LAPCE_BUTTON_PRIMARY_FOREGROUND))
                    .background(
                        config.color(SnowflakeColor::LAPCE_BUTTON_PRIMARY_BACKGROUND),
                    )
                    .margin_left(6.0)
                    .padding_horiz(6.0)
                    .border_radius(6.0)
                    ...
                    .disabled(|s| s.background(config.color(SnowflakeColor::EDITOR_DIM)))
            })
        };
