    ...
    stack((
        h_stack((
            clickable_icon_base(
                move || {
                    if open.get() {
                        SnowflakeIcons::PANEL_FOLD_DOWN
                    } else {
                        SnowflakeIcons::PANEL_FOLD_UP
                    }
                },
                None::<Box<dyn Fn()>>,
                || false,
...
pub fn panel_container_view(
            ...
            .style(move |s| {
                ...
                s.absolute()
                    ...
                    .apply_if(is_dragging, |s| {
                        s.background(config.color(SnowflakeColor::EDITOR_CARET))
                            .apply_if(
    ...
    .style(move |s| {
        ...
        s.apply_if(!panel.is_container_shown(&position, true), |s| s.hide())
            ...
            .color(config.color(SnowflakeColor::PANEL_FOREGROUND))
    })
