...
use crate::{
    ...
    command::{
        CommandKind, InternalCommand, SnowflakeCommand, SnowflakeWorkbenchCommand,
        WindowCommand,
    },
    config::{
        SnowflakeConfig, color::SnowflakeColor, icon::SnowflakeIcons, ui::TabSeparatorHeight,
    ...
    workspace::{SnowflakeWorkspace, SnowflakeWorkspaceType},
};
...
#[derive(Debug)]
struct Cli {
    /// Launch new window even if Snowflake is already running
    ...
    #[clap(value_parser = snowflake_proxy::cli::parse_file_line_column)]
...
pub struct AppData {
    ...
    pub config: RwSignal<Arc<SnowflakeConfig>>,
...
impl AppData {
    pub fn reload_config(&self) {
        let config =
            SnowflakeConfig::load(&SnowflakeWorkspace::default(), &[], &self.plugin_paths);
    ...
    pub fn new_window(&self, folder: Option<PathBuf>) {
        let config = self
            ...
            .or_else(|| {
                let db: Arc<SnowflakeDb> = use_context().unwrap();
        ...
        let workspace = SnowflakeWorkspace {
            path: folder,
            ..Default::default()
        };
    ...
    fn create_windows(
        ...
        if !dirs.is_empty() {
            ...
            for dir in dirs {
                ...
                {
                    SnowflakeWorkspaceType::RemoteWSL(crate::workspace::WslHost {
                        host: String::new(),
                    })
                } else {
                    SnowflakeWorkspaceType::Local
                };
                #[cfg(not(windows))]
                let workspace_type = SnowflakeWorkspaceType::Local;
                ...
                let info = WindowInfo {
                    ...
                    tabs: TabsInfo {
                        active_tab: 0,
                        workspaces: vec![SnowflakeWorkspace {
                            kind: workspace_type,
        ...
        if inital_windows == 0 {
            let mut info = db.get_window().unwrap_or_else(|_| WindowInfo {
                ...
                tabs: TabsInfo {
                    active_tab: 0,
                    workspaces: vec![SnowflakeWorkspace::default()],
                },
            });
            info.tabs = TabsInfo {
                active_tab: 0,
    ...
    let view_fn = move |(i, layout_rect, child): (
        ...
        let child_view = {
                            ...
                            .apply_if(
                                !info.with(|info| info.is_pristine)
                                    && config.ui.tab_close_button
                                        == TabCloseButton::Off,
                                |s| s.color(config.color(SnowflakeColor::LAPCE_WARN)),
                            )
                    })
            })
            .style(|s| s.padding(4.));
            ...
            let tab_close_button = clickable_icon(
                move || {
                    if hovered.get() || info.with(|info| info.is_pristine) {
                        SnowflakeIcons::CLOSE
                    } else {
                        SnowflakeIcons::UNSAVED
                    }
                },
                move || {
                    let editor_tab_id =
            ...
            .style(move |s| {
                s.items_center()
                    ...
                    .border_right(1.0)
                    .border_color(config.get().color(SnowflakeColor::LAPCE_BORDER))
                    .padding_horiz(6.)
                    .gap(6.)
                    .grid()
            ...
            child_view
                ...
                .dragging_style(move |s| {
                    ...
                    s.border(1.0)
                        ...
                        .background(
                            config
                                .color(SnowflakeColor::PANEL_BACKGROUND)
                                .multiply_alpha(0.7),
                        )
                        .border_color(config.color(SnowflakeColor::LAPCE_BORDER))
                })
                ...
                .style(move |s| {
                    s.size_full()
                        ...
                        .border_color(config.get().color(if is_focused() {
                            SnowflakeColor::LAPCE_TAB_ACTIVE_UNDERLINE
                        } else {
                            SnowflakeColor::LAPCE_TAB_INACTIVE_UNDERLINE
                        }))
                })
                .style(|s| {
                    s.absolute()
                ...
                .style(move |s| {
                    ...
                    s.absolute()
                        ...
                        .border_color(
                            config
                                .get()
                                .color(SnowflakeColor::LAPCE_TAB_ACTIVE_UNDERLINE)
                                .multiply_alpha(0.5),
                        )
                })
        ...
        .style(move |s| {
            ...
            s.height_full()
                ...
                .hover(|s| s.background(config.color(SnowflakeColor::HOVER_BACKGROUND)))
        })
    ...
    stack((
            ...
            (
                clip(empty().style(move |s| {
                    ...
                    s.absolute()
                        ...
                        .background(config.color(SnowflakeColor::PANEL_BACKGROUND))
                        .box_shadow_blur(3.0)
                        .box_shadow_color(
                            config.color(SnowflakeColor::LAPCE_DROPDOWN_SHADOW),
                        )
                }))
                .style(move |s| {
                ...
                stack((
                    clickable_icon(
                        || SnowflakeIcons::TAB_PREVIOUS,
                        move || {
                            workbench_command
                                .send(SnowflakeWorkbenchCommand::PreviousEditorTab);
                        },
                        || false,
                        || false,
                        || "Previous Tab",
                    ...
                    clickable_icon(
                        || SnowflakeIcons::TAB_NEXT,
                        move || {
                            workbench_command
                                .send(SnowflakeWorkbenchCommand::NextEditorTab);
                        },
                        || false,
                        || false,
                        || "Next Tab",
        ...
        stack({
            ...
            (
                ...
                stack((
                    clickable_icon(
                        || SnowflakeIcons::SPLIT_HORIZONTAL,
                        move || {
                            let editor_tab_id =
                                editor_tab.with_untracked(|t| t.editor_tab_id);
                    ...
                    stack((
                        ...
                        .style(move |s| {
                            s.height_full()
                                ...
                                .border_right(1.0)
                                .border_color(
                                    config.get().color(SnowflakeColor::LAPCE_BORDER),
                                )
                        }),
                        container(
                            editor_container_view(
                ...
                .style(move |s| {
                    ...
                    s.absolute()
                        ...
                        .background(
                            config
                                .get()
                                .color(SnowflakeColor::EDITOR_DRAG_DROP_BACKGROUND),
                        )
                })
...
fn split_resize_border(
    ...
    config: ReadSignal<Arc<SnowflakeConfig>>,
) -> impl View {
            ...
            .style(move |s| {
                ...
                s.position(Position::Absolute)
                    ...
                    .apply_if(is_dragging, |s| {
                        ...
                        .background(config.get().color(SnowflakeColor::EDITOR_CARET))
                    })
                    .hover(|s| {
                        s.cursor(match direction {
                            SplitDirection::Vertical => CursorStyle::ColResize,
    ...
    dyn_stack(
        ...
        move |(_, content)| {
            container(empty().style(move |s| {
                ...
                .background(config.get().color(SnowflakeColor::LAPCE_BORDER))
            }))
            .style(move |s| {
...
fn main_split(window_tab_data: Rc<WindowTabData>) -> impl View {
    ...
    .style(move |s| {
        ...
        s.border_color(config.color(SnowflakeColor::LAPCE_BORDER))
            .background(config.color(SnowflakeColor::EDITOR_BACKGROUND))
    ...
    let view = container(
        svg(move || config.get().ui_svg(icon()))
            .style(move |s| {
                ...
                let size = config.ui.icon_size() as f32;
                s.size(size, size)
                    .color(config.color(SnowflakeColor::LAPCE_ICON_ACTIVE))
                    .disabled(|s| {
                        s.color(config.color(SnowflakeColor::LAPCE_ICON_INACTIVE))
    ...
    .style(move |s| {
        ...
        s.padding(4.0)
            ...
            .apply_if(active_fn(), |s| {
                s.border_color(config.color(SnowflakeColor::EDITOR_CARET))
            })
            .hover(|s| {
                s.cursor(CursorStyle::Pointer)
                    .background(config.color(SnowflakeColor::PANEL_HOVERED_BACKGROUND))
            })
            .active(|s| {
                s.background(
                    config.color(SnowflakeColor::PANEL_HOVERED_ACTIVE_BACKGROUND),
                )
            })
    });
...
fn tooltip_tip<V: View + 'static>(
    ...
    container(child).style(move |s| {
        ...
        s.padding_horiz(10.0)
            ...
            .color(config.color(SnowflakeColor::TOOLTIP_FOREGROUND))
            .background(config.color(SnowflakeColor::TOOLTIP_BACKGROUND))
            .border(1)
            .border_radius(6)
            .border_color(config.color(SnowflakeColor::LAPCE_BORDER))
            .box_shadow_blur(3.0)
            .box_shadow_color(config.color(SnowflakeColor::LAPCE_DROPDOWN_SHADOW))
            .margin_left(0.0)
            .margin_top(4.0)
    })
}
...
fn palette_item(
    workspace: Arc<SnowflakeWorkspace>,
    i: usize,
    item: PaletteItem,
            ...
            container(
                stack((
                    ...
                    focus_text(
                        ...
                        move || config.get().color(SnowflakeColor::EDITOR_FOCUS),
                    )
                    ...
                    .style(move |s| {
                        s.color(config.get().color(SnowflakeColor::EDITOR_DIM))
                            .min_width(0.0)
                            .flex_grow(1.0)
                            .flex_basis(0.0)
                    }),
            ...
            container(
                stack((
                    svg(move || {
                        ...
                        config
                            .symbol_svg(&kind)
                            .unwrap_or_else(|| config.ui_svg(SnowflakeIcons::FILE))
                    })
                    .style(move |s| {
                        let config = config.get();
                        let size = config.ui.icon_size() as f32;
                        s.min_width(size).size(size, size).margin_right(5.0).color(
                            config.symbol_color(&kind).unwrap_or_else(|| {
                                config.color(SnowflakeColor::LAPCE_ICON_ACTIVE)
                            }),
                        )
                    }),
                    focus_text(
            ...
            container(
                stack((
                    svg(move || {
                        let config = config.get();
                        match mode {
                            RunDebugMode::Run => config.ui_svg(SnowflakeIcons::START),
                            RunDebugMode::Debug => config.ui_svg(SnowflakeIcons::DEBUG),
                        }
                    })
                    .style(move |s| {
                        let config = config.get();
    ...
    .style(move |s| {
        s.width_full()
            ...
            .apply_if(index.get() == i, |style| {
                style.background(
                    config.get().color(SnowflakeColor::PALETTE_CURRENT_BACKGROUND),
                )
            })
    })
}
                    ...
                    .style(move |s| {
                        s.width_full().cursor(CursorStyle::Pointer).hover(|s| {
                            s.background(
                                config
                                    .get()
                                    .color(SnowflakeColor::PANEL_HOVERED_BACKGROUND),
                            )
                        })
                    })
                },
    ...
    container(
        ...
        .style(move |s| {
            ...
            s.width(config.ui.palette_width() as f64)
                ...
                .border_color(config.color(SnowflakeColor::LAPCE_BORDER))
                .flex_col()
                .background(config.color(SnowflakeColor::PALETTE_BACKGROUND))
                .pointer_events_auto()
        }),
    )
    .style(move |s| {
            ...
            stack((
                svg(move || {
                    if let MessageType::ERROR = message.typ {
                        config.get().ui_svg(SnowflakeIcons::ERROR)
                    } else {
                        config.get().ui_svg(SnowflakeIcons::WARNING)
                    }
                })
                .style(move |s| {
                    let config = config.get();
                    ...
                    let color = if let MessageType::ERROR = message.typ {
                        config.color(SnowflakeColor::LAPCE_ERROR)
                    } else {
                        config.color(SnowflakeColor::LAPCE_WARN)
                    };
                    s.min_width(size)
                        .size(size, size)
                        .margin_right(10.0)
...
fn completion(window_tab_data: Rc<WindowTabData>) -> impl View {
                    ...
                    .style(move |s| {
                        ...
                        s.padding_horiz(5.0)
                            ...
                            .apply_if(active.get() == i, |s| {
                                s.background(
                                    config.color(SnowflakeColor::COMPLETION_CURRENT),
                                )
                            })
                            .hover(move |s| {
                                s.background(
    ...
    .style(move |s| {
        ...
        s.position(Position::Absolute)
            ...
            .margin_left(origin.x as f32)
            .margin_top(origin.y as f32)
            .background(config.color(SnowflakeColor::COMPLETION_BACKGROUND))
...
fn code_action(window_tab_data: Rc<WindowTabData>) -> impl View {
    ...
    .style(move |s| {
        ...
        .margin_left(origin.x as f32)
        .margin_top(origin.y as f32)
        .background(config.get().color(SnowflakeColor::COMPLETION_BACKGROUND))
        .border_radius(6.0)
    })
...
fn rename(window_tab_data: Rc<WindowTabData>) -> impl View {
    ...
    .style(move |s| {
        ...
        s.position(Position::Absolute)
            ...
            .margin_left(origin.x as f32)
            .margin_top(origin.y as f32)
            .background(config.get().color(SnowflakeColor::PANEL_BACKGROUND))
            .border_radius(6.0)
            .padding(6.0)
    })
...
fn window_tab(window_tab_data: Rc<WindowTabData>) -> impl View {
    ...
    .style(move |s| {
        let config = config.get();
        s.size_full()
            .color(config.color(SnowflakeColor::EDITOR_FOREGROUND))
            .background(config.color(SnowflakeColor::EDITOR_BACKGROUND))
            .font_size(config.ui.font_size() as f32)
            ...
            .class(floem::views::scroll::Handle, |s| {
                s.background(config.color(SnowflakeColor::LAPCE_SCROLL_BAR))
            })
    })
...
fn workspace_title(workspace: &SnowflakeWorkspace) -> Option<String> {
    let p = workspace.path.as_ref()?;
    let dir = p.file_name().unwrap_or(p.as_os_str()).to_string_lossy();
    Some(match &workspace.kind {
        SnowflakeWorkspaceType::Local => format!("{dir}"),
        SnowflakeWorkspaceType::RemoteSSH(remote) => format!("{dir} [{remote}]"),
        #[cfg(windows)]
        SnowflakeWorkspaceType::RemoteWSL(remote) => format!("{dir} [{remote}]"),
    })
}
        ...
        stack((
            ...
            .dragging_style(move |s| {
                ...
                s.border(1.0)
                    ...
                    .color(
                        config
                            .color(SnowflakeColor::EDITOR_FOREGROUND)
                            .multiply_alpha(0.7),
                    )
                    .background(
                        config
            ...
            empty().style(move |s| {
                ...
                s.absolute()
                    ...
                    .height_full()
                    .border_color(
                        config.get().color(SnowflakeColor::LAPCE_TAB_ACTIVE_UNDERLINE),
                    )
        ...
        container(clickable_icon(
            ...
            move || {
                window_data.run_window_command(WindowCommand::NewWorkspaceTab {
                    workspace: SnowflakeWorkspace::default(),
                    end: true,
                });
            },
            || false,
...
fn window(window_data: WindowData) -> impl View {
    ...
    .window_title(move || {
        ...
        match workspace {
            Some(workspace) => format!("{workspace} - Snowflake"),
    ...
    .window_menu(move || {
        ...
        if let Some((_, window_tab)) = window_tab {
            ...
            let snowflake_command = window_tab.common.snowflake_command;
            window_menu(snowflake_command, workbench_command)
        } else {
            Menu::new("Snowflake")
        }
    })
...
pub fn launch() {
    ...
    trace!(TraceLevel::INFO, "Starting up Snowflake..");
    ...
    if !cli.wait {
        ...
        if let Err(why) = cmd
            ...
            .stderr(stderr)
            .stdout(stdout)
            .env("LAPCE_LOG", "snowflake_app::app=error,off")
            .spawn()
        {
            eprintln!("Failed to launch snowflake: {why}");
            std::process::exit(1);
        };
        return;
    }
    ...
    // in the existing Snowflake process
    if !cli.new {
        match get_socket() {
            Ok(socket) => {
    ...
    if let Err(err) = snowflake_proxy::register_snowflake_path() {
        tracing::error!("{:?}", err);
    }
    let db = match SnowflakeDb::new() {
        Ok(db) => Arc::new(db),
        Err(e) => {
            #[cfg(windows)]
            logging::error_modal("Error", &format!("Failed to create SnowflakeDb: {e}"));

            trace!(TraceLevel::ERROR, "Failed to create SnowflakeDb: {e}");
            std::process::exit(1);
        }
    };
    let scope = Scope::new();
    ...
    if let Some(path) = SnowflakeConfig::settings_file() {
    ...
    if let Some(path) = SnowflakeConfig::keymaps_file() {
        if let Err(err) = watcher.watch(&path, notify::RecursiveMode::Recursive) {
            tracing::error!("{:?}", err);
        }
    }
    ...
    let config = SnowflakeConfig::load(&SnowflakeWorkspace::default(), &[], &plugin_paths);
    ...
    #[cfg(feature = "updater")]
    {
        ...
        std::thread::Builder::new()
            .name("SnowflakeUpdater".to_owned())
            .spawn(move || {
                loop {
...
pub fn try_open_in_existing_process(
    ...
    snowflake_rpc::stdio::write_msg(&mut socket, msg)?;
        ...
        std::thread::spawn(move || -> Result<()> {
            ...
            loop {
                let msg: Option<CoreMessage> =
                    snowflake_rpc::stdio::read_msg(&mut reader)?;
...
pub fn window_menu(
    snowflake_command: Listener<SnowflakeCommand>,
    workbench_command: Listener<SnowflakeWorkbenchCommand>,
) -> Menu {
    Menu::new("Snowflake")
        .entry({
            let mut menu = Menu::new("Snowflake")
                .entry(MenuItem::new("About Snowflake").action(move || {
                    workbench_command.send(SnowflakeWorkbenchCommand::ShowAbout)
                }))
                .separator()
                .entry(
                    Menu::new("Settings...")
                        .entry(MenuItem::new("Open Settings").action(move || {
                            workbench_command
                                .send(SnowflakeWorkbenchCommand::OpenSettings);
                        }))
                        .entry(MenuItem::new("Open Keyboard Shortcuts").action(
                            move || {
                                workbench_command.send(
                                    SnowflakeWorkbenchCommand::OpenKeyboardShortcuts,
                                );
                            },
                        )),
                )
                .separator()
                .entry(MenuItem::new("Quit Snowflake").action(move || {
                    workbench_command.send(SnowflakeWorkbenchCommand::Quit);
                }));
            if cfg!(target_os = "macos") {
                menu = menu
                    .separator()
                    .entry(MenuItem::new("Hide Snowflake"))
        ...
        .entry(
            Menu::new("File")
                .entry(MenuItem::new("New File").action(move || {
                    workbench_command.send(SnowflakeWorkbenchCommand::NewFile);
                }))
                .separator()
                .entry(MenuItem::new("Open").action(move || {
                    workbench_command.send(SnowflakeWorkbenchCommand::OpenFile);
                }))
                .entry(MenuItem::new("Open Folder").action(move || {
                    workbench_command.send(SnowflakeWorkbenchCommand::OpenFolder);
                }))
                .separator()
                .entry(MenuItem::new("Save").action(move || {
                    snowflake_command.send(SnowflakeCommand {
                        kind: CommandKind::Focus(FocusCommand::Save),
                        data: None,
                    });
                }))
                .entry(MenuItem::new("Save All").action(move || {
                    workbench_command.send(SnowflakeWorkbenchCommand::SaveAll);
                }))
                .separator()
                .entry(MenuItem::new("Close Folder").action(move || {
                    workbench_command.send(SnowflakeWorkbenchCommand::CloseFolder);
                }))
                .entry(MenuItem::new("Close Window").action(move || {
                    workbench_command.send(SnowflakeWorkbenchCommand::CloseWindow);
                })),
        )
        .entry(
            Menu::new("Edit")
