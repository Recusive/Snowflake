...
pub struct KeymapPicker {
    cmd: RwSignal<Option<SnowflakeCommand>>,
...
pub fn keymap_view(editors: Editors, common: Rc<CommonData>) -> impl View {
    ...
    let items = move || {
        ...
        let mut items = keypress
            ...
            .collect::<im::Vector<(SnowflakeCommand, Option<KeyMap>)>>();
        ...
        items
            .into_iter()
            .enumerate()
            .collect::<im::Vector<(usize, (SnowflakeCommand, Option<KeyMap>))>>()
    };

    let view_fn =
        move |(i, (cmd, keymap)): (usize, (SnowflakeCommand, Option<KeyMap>))| {
            ...
            .style(move |s| {
                ...
                s.items_center()
                    ...
                    .width_pct(100.0)
                    .apply_if(i % 2 > 0, |s| {
                        s.background(config.color(SnowflakeColor::EDITOR_CURRENT_LINE))
                    })
                    .border_bottom(1.0)
    ...
    stack((
        ...
        .style(move |s| {
            ...
            s.font_bold()
                ...
                .border_bottom(1.0)
                .border_color(config.color(SnowflakeColor::LAPCE_BORDER))
                .background(config.color(SnowflakeColor::EDITOR_CURRENT_LINE))
        }),
        container(
            scroll(
                virtual_stack(
                    ...
                    |(i, (cmd, keymap)): &(
                        usize,
                        (SnowflakeCommand, Option<KeyMap>),
