...
use snowflake_rpc::terminal::TermId;

use super::kind::PanelKind;
use crate::{
    app::clickable_icon,
    command::{InternalCommand, SnowflakeWorkbenchCommand},
...
fn terminal_tab_header(window_tab_data: Rc<WindowTabData>) -> impl View {
    ...
    stack((
        ...
        container(clickable_icon(
            || SnowflakeIcons::ADD,
            move || {
                workbench_command.send(SnowflakeWorkbenchCommand::NewTerminalTab);
            },
            || false,
            || false,
            || "New Terminal",
